    ...
    <div className="cue-green">
      <section className="page-hero" aria-labelledby="page-title">
        <div className="container narrow">
          ...
          <h1 id="page-title">Ethiopian green coffee for importers and roasters</h1>
          <p className="lead">
            We help importers, roasters and other trade buyers source unroasted Ethiopian coffee through our network of Ethiopian
            exporters. You tell us what you need; we check what can be offered, gather the details and samples you need to decide, and
            coordinate the process through to the exporter’s quotation and shipment.
          </p>
